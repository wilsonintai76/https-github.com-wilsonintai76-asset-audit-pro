...
import { Lock, ShieldCheck, Eye, Calendar, UserCheck, Users, UserPlus, Edit, ShieldAlert, Network, X, AlertCircle } from 'lucide-react';
...
export const RBACMatrix: React.FC<RBACMatrixProps> = ({ showToast }) => {
